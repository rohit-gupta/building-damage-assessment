...
print(np.max(pre_gt_class)), print(np.min(pre_gt_class))
print(np.max(post_gt_class)), print(np.min(post_gt_class))

print(np.max(pre_pred_class)), print(np.min(pre_pred_class))
print(np.max(post_pred_class)), print(np.min(post_pred_class))

Image.fromarray(pre_gt_class).save("scoring/targets/test_localization_00000_target.png")
Image.fromarray(post_gt_class).save("scoring/targets/test_damage_00000_target.png")
Image.fromarray(pre_pred_class).save("scoring/predictions/test_localization_00000_prediction.png")
Image.fromarray(post_pred_class).save("scoring/predictions/test_damage_00000_prediction.png")
